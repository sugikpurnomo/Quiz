...
if(isset($_POST['hitung_bmi'])){
	...
	if ($bmi <= 18.5) {
	    $output = '<b style="color:purple;"><i>Kekurangan Berat Badan...</i></b>';
	     $saran = "Makan dan istirahatlah yang cukup....";

	  } else if ($bmi > 18.5 && $bmi<=24.9 ) {
	    $output = '<b style="color:green;"><i>Berat Badan Normal...</i></b>';
	    $saran = "Tetap jaga kesehatan dengan berolahraga dan menjaga pola makan anda....";

	  } else if ($bmi > 24.9 && $bmi<=29.9) {
	    $output = '<b style="color:yellow;"><i>Kelebihan Berat Badan...</i></b>';
	    $saran = "Anda sebaiknya diet dan mengatur pola makan...";

	  } else if ($bmi > 30.0) {
	    $output = '<b style="color:red;"><i>Obesitas...</i></b>';
	    $saran = "Anda harus diet dan banyak berolahraga...";
	  }	
	  }		
} else {
	echo "<script> window.alert('Anda tidak diperkenankan...');window.location='./.';</script>" ;
}
 ...
 <form>
    <div class="field_container">
    	<p style="text-align: justify;"><center><h4>Hasil Perhitungan</h4></center>
    	Hasil Perhitungan IMT Anda : <?php echo round($bmi,2) ?><br>
      ...
      <center>
      <a onclick="window.history.go(-1)"><button >
       <<--Kembali
      </button></a>
      </center>
